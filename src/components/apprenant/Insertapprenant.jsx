...
import { addApprenant } from '../../Services/apprenantservice';

function Insertapprenant() {
    ...
    <>
      ...
      <div className="container w-100 d-flex justify-content-center">
        <div className=' mt-5 w-50'>
          <h1 align="center">Ajout apprenant</h1>
...
export default Insertapprenant
